...
class Connection:
    ...
    def on_connected(self, con, con_type):
        ...
        auth = self.client.auth(self.jid.getNode(), self.password, resource=self.jid.getResource(), sasl=0, on_auth=self.on_auth)
    ...
    def connect(self):
        ...
        self.con = self.client.connect(self.on_connected, self.on_connection_failed, secure_tuple=('plain', '', ''))
